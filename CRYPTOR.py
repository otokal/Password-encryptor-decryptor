...
class MyWindow(tk.Tk):
    ...
    def open_window1(self):
        ...
        # Create Encrypt button, password text box, and encrypted password text box
    ...
    def open_window2(self):
        ...
        # Create Decrypt button and Decrypted Password text box
...
# Create an instance of the custom MyWindow class
window = MyWindow()
